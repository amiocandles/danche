...
export default class Buttons extends React.Component {
    ...
    remove = (targetKey) => {
        ...
        this.state.panes.forEach((pane, i) => {//从索引中遍历
            if (pane.key === targetKey) {
                lastIndex = i - 1;
            }
        });
        //过滤出要删除的对象，把删除后剩下的页签显示出来
            ...
            <div>
                <Card title="Tab页签" className="card-wrap">
                    <Tabs defaultActiveKey="1" onChange={this.handleCallback}>
                        <TabPane tab="Tab 1" key="1">我在学习React课程</TabPane>
                ...
                <Card title="Tab带图的页签" className="card-wrap">
                    <Tabs defaultActiveKey="1" onChange={this.handleCallback}>
                        <TabPane tab={<span><Icon type="plus" />Tab 1</span>} key="1">我在学习React课程</TabPane>
                        <TabPane tab={<span><Icon type="edit" />Tab 2</span>} key="2">我在学习React课程</TabPane>
